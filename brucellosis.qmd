...
```{r cleaning the population data to be used}
...
```{r All counties model (combined with NA) at alg 2 and 3}
# Lag 2
df_cum_2_2 <- df_cum |> 
  as_tibble() %>%
  mutate_at(vars(animal_incidence),
...
```
http://127.0.0.1:15025/graphics/57f7ff83-beca-4f9e-a9e6-345dcd5660f2.png
The data was the cleaned as follows;\
\
